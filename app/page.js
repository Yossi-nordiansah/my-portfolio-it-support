          ...
          <div className="h-20 md:h-24 flex items-center justify-center">
            <TypeAnimation
              sequence={[
                "IT Support & IT Staff",
                2000,
                "Web Programmer (React / Next.js)",
                2000,
                "Network & Server Administrator",
                2000,
                "Helpdesk & Troubleshooting Expert",
                2000,
              ]}
              wrapper="h2"
              speed={50}
          ...
          <div className="relative order-2 lg:order-1" data-aos="fade-right">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 p-3 md:p-10 rounded-3xl shadow-2xl">
              ...
              <p className="text-slate-300 text-lg leading-relaxed font-inter text-justify">
                IT Support / IT Staff with a strong background in software
                development and hands-on experience supporting daily IT
                operations. Skilled in
                <span className="text-cyan-400 font-semibold">
                  {" "}hardware & software troubleshooting
                </span>
                , OS installation & configuration, and end-user support.
                Capable of handling
                <span className="text-blue-400 font-semibold">
                  {" "}basic networking needs
                </span>{" "}
                (LAN, Mikrotik, routing), Linux server administration, and
                web development (React.js / Next.js / Laravel). Good problem
                analysis skills, neat technical documentation, and experienced
                in collaborative work with both technical and operational teams.
              </p>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-[201] p-4 animate-in fade-in duration-300">
          <div className="relative w-full max-w-5xl h-[85vh] bg-slate-900 rounded-2xl overflow-hidden shadow-2xl border border-white/10">
            ...
            <div className="pt-14 bg-slate-800/50">
              <PDFViewer url="/pdf/Yossi_Nordiansah_resume_local_staff.pdf" />
            </div>
          </div>
        </div>
      )}
